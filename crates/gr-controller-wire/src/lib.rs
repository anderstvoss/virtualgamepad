...
pub const STANDARD_GAMEPAD_DESCRIPTOR: &[u8] = &[
    ...
    0x01, 0x81, 0x03, 0x15, 0x00, 0x26, 0xff, 0x00, 0x75, 0x08, 0x95, 0x06, 0x09, 0x30, 0x09, 0x31,
    0x09, 0x32, 0x09, 0x33, 0x09, 0x34, 0x09, 0x35, 0x81, 0x02, 0xc0,
];
...
mod tests {
    ...
    fn curated_descriptors_and_feature_shapes_are_fixed() {
        assert_eq!(STANDARD_GAMEPAD_DESCRIPTOR.len(), 75);
